/*
	...
	Changelog:
	* colourMode: changed quick deal from yellow to white
*/
...
void colourMode()
{
	...
	while (SensorValue[S3] != (int)colorGreen && SensorValue[S3] != (int)colorBlue && SensorValue[S3] != (int)colorRed && SensorValue[S3] != (int)colorWhite)
	{}
	...
	else if (SensorValue[S3] == (int)colorWhite)
	{
