/*
	...
	Changelog:
	* Added eraseDisplay() at the start of each game's function
	* colourMode: added extra display text
	* colourMode: quick deal now appears above president
	* playPresident: splits up the deck evenly between the players
	* adjusted eraseDisplay() locations throughout code
	* playGoFish: added extra text for number of players
*/
