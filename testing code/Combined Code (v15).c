/*
	...
	Changelog:
	* went through all the functions and made sure no lines of the display were cut off
	* dealCards: MED_SPEED changed from 15 -> 12
	* main: changed while conditions to wait for buttonLeft, Right, or Down
*/
...
task main()
{
	...
	while (programRunning)
	{
		...
		displayString(8, "Press the down button to quit");
