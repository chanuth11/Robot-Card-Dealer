/*
	...
	Changelog:
	* dealLinear function changed to prevent dealing the whole deck
	* driveDist function adjusted to accept negative distances
	* Poker display split into multiple lines
*/
