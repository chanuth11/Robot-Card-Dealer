/*
	...
	Changelog:
	* playPoker: DIST_TO_PLAYER changed from 100 -> 50
	* playPoker: distToDiscard changed from 20 -> 30 and DIST_BW_CARDS changed from 10 -> 20
	* dealLinear: DIST_BW_PILES changed from 10 -> 20
	* main: added shut off functionality
*/
...
task main()
{
	...
	while (programRunning)
	{
		...
		displayString(8, "Press the down button to quit the program");
